// Name: Kate Moreland
// UserID: kem0149
// FileName: project4_Moreland_kem0149.cpp
// Compile: g++ project4_Moreland_kem0149.cpp
// Run: ./a.out
...
//number of questions in linked list
int question_amount = 0;

//struct for trivia questions
struct TriviaNode {
...
int main() {
	...
	cout << "*** Welcome to Kate's trivia quiz game ***\n";
	string input;
